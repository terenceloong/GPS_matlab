function nav_tight_yaw_nacc()
% 紧组合后处理程序，使用航向角作为量测，不包含加速度计零偏，14维模型
% 标$的换数据时需要修改
...
% 结果：静止时水平姿态稳定，精度依赖于加计零偏大小，为了抵抗加计零偏对速度的影响，需要将速度对应的Q放大
% 0726数据验证通过
...
NF = navFilter_tight_open_yaw_nacc([lat, lon, h], ...
                    [0, 0, 0] + [1, -1, 0.5]*0, ...
